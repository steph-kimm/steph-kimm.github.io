...
function insertWordOnPage(word, x, y){
  ...
  h.style.top= y + 'px';
  var fontType = ["Comic Sans MS" , "Arial Black" , "Jazz LET" ];
  var num = Math.floor(Math.random()*3);
  h.style.fontFamily = fontType[num] ;
  var colores = ["lightgrey" , "skyblue", "yellow"]
  h.style.color = colores[num] ;
